...
public class VentanaCartaGasteiz extends JFrame {
	...
	public VentanaCartaGasteiz(JFrame va) {
		super();
		vActual=this;
		vAnterior=va;
		setTitle("Carta");
		...
		btnHamburguesasNorte.addActionListener((e)->{
			VentanaHamburguesasGasteiz v = new VentanaHamburguesasGasteiz();
			v.setVisible(true);
		});
		...
		btnMenuNorte.addActionListener((e)->{
			VentanaMenuGasteiz v = new VentanaMenuGasteiz();
			v.setVisible(true);
		});
