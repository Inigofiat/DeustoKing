...
public class VentanaHamburguesasGasteiz extends JFrame {
	...
	public VentanaHamburguesasGasteiz() {
		...
		btnH4 = new JButton();
		ImageIcon imAlitas = new ImageIcon("src\\imagenes\\gasteiz.png");
		lblH4 = new JLabel("GASTEIZ BURGER");
	...
	public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new VentanaHamburguesasGasteiz();
            }
        });
    }
}
