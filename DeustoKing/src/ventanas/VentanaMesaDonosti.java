...
public class VentanaMesaDonosti extends JFrame{
	private JPanel pNorte,pCentro,pSur,pCentroIzquierda,pCentroDerecha;
	private JButton btnMesa1, btnMesa2, btnMesa3,btnMesa4,btnMesa5,btnMesa6,btnMesa7,btnAtras;
	private JFrame vActual,vAnterior;
	private JLabel lblTitulo;
	

	public VentanaMesaDonosti(JFrame va) {
		super();
		vActual = this;
		vAnterior = va;
		...
		setVisible(true);
		setTitle("Mesas disponibles en Gazteiz");
		...
		lblTitulo = new JLabel("Reserva una mesa en Donosti: ");
		...
		pCentroDerecha.add(btnMesa7);
		btnMesa7.setPreferredSize(new Dimension(250,350));
		btnMesa7.setMargin(new Insets(10, 10, 10, 10));
		btnMesa7.setBackground(new Color(162,240,163));
