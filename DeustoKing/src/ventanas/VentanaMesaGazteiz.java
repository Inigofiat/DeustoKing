...
public class VentanaMesaGazteiz extends JFrame{
	...
	public VentanaMesaGazteiz(JFrame va) {
		super();
		vActual = this; 
		vAnterior = va;    
		...
		lblTitulo = new JLabel("Reserva una mesa en Gazteiz: ");
