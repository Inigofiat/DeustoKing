...
//	
//	private JPanel pTitulo, pPrincipal, pVolver, pContenedor;
...
//	}
//	
//	private static void obtenerEntrantes() {
//		System.out.println("CARGANDO ENTRANTES");
//		for (Producto p : Restaurante.getListaProductosFichero()) {
//			System.out.println("DENTRO");
//			if(p.getProducto().equals(TipoProducto.ENTRANTE)) {
...
//		JLabel lb = new JLabel(nombreProducto);
...
//		lb.setHorizontalAlignment(SwingUtilities.LEFT);
//		lb.setVerticalAlignment(SwingUtilities.TOP);
//		lb.setForeground(Color.WHITE);
//		lb.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 35));
//		boton.add(lb, BorderLayout.CENTER);
...
//		}
//		
//		return descripcionFormateada.toString();
//	}
//	
//	public static void main(String[] args) {
//		new VentanaEntrantes(null);
//	}
//}
package ventanas;
...
public class VentanaEntrantes extends JFrame {
	...
	private static void obtenerEntrantes() {
		...
		for(Producto p: Restaurante.getListaProductosFichero()) {
			...
			if( p.getTipoProducto().equals(TipoProducto.ENTRANTE)) {
				crearBoton("imagenes/"+p.getImagen(), p.getNombre(), dividirDescripcionPorPalabras(p.getDescripcion()), p.getPrecio());
			}
		}
	}
