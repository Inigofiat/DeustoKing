...
public class VentanaMenuBilbo extends JFrame {
	...
	public VentanaMenuBilbo() {
        ...
        lblTitulo = new JLabel("MENÚ BILBO");
		...
		btnM1 = new JButton();
		ImageIcon imNachos = new ImageIcon("src\\imagenes\\bilboburger.jpg");
		lblM1 = new JLabel("BILBO BURGER");
